package com.avizii.backup.photon.util;
...
public class ParamsUtil {
  ...
  public int getIntParamAndCheck(String key) throws Exception {
    ...
    if (hasParam(key)) return NumberUtil.getIntValue(getParam(key));
    else {
      this.showHelp();
  ...
  public long getLongParamAndCheck(String key) throws Exception {
    ...
    if (hasParam(key)) return NumberUtil.getLongValue(getParam(key));
    else {
      this.showHelp();
      throw new Exception("参数中没有包含" + key + "参数");
    }
  ...
  public double getDoubleParamAndCheck(String key) throws Exception {
    ...
    if (hasParam(key)) return NumberUtil.getDoubleValue(getParam(key));
    else {
      this.showHelp();
      throw new Exception("参数中没有包含" + key + "参数");
    }
  ...
  public boolean getBooleanParamAndCheck(String key) throws Exception {
    ...
    if (hasParam(key)) return "true".equals(getParam(key, "").toLowerCase());
    else {
      this.showHelp();
      throw new Exception("参数中没有包含" + key + "参数");
    }
  ...
  public static void main(String[] args) throws Exception {
    ...
    //		System.out.println("endMain:"+"pv_proxy
    // sdf".equals(paramsUtil.getEndMainParam()));
